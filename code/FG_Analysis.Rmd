...
print(allfungi_obj)
```
We can see that the number of rows decreased in both the tax_data (i.e., ASV counts) and the class_data (i.e., taxonomy) tables. Specifically, the ASV_counts_taxa tablse now have fewer rows than it did previously.
