...
Make boxplots of diversity at each order of q

```{r}
(bact_diversity_fig <- ggplot(bact_hill_table_melted, aes(x = Diversity_order, y = Hill_number, fill = Management_type)) +
  geom_boxplot() +
...
```{r}
(allfungi_diversity_fig <- ggplot(allfungi_hill_table_melted, aes(x = Diversity_order, y = Hill_number, fill = Management_type)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#ffffff", "#a9a9a9")) +
  xlab("Order of diversity (q)") +
  ylab("Hill number") +
...
```{r}
(AMFfungi_diversity_fig <- ggplot(AMFfungi_hill_table_melted, aes(x = Diversity_order, y = Hill_number, fill = Management_type)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#ffffff", "#a9a9a9")) +
  xlab("Order of diversity (q)") +
  ylab("Hill number") +
...
Replot the all_fungi dataset without the outlier.
```{r}
(allfungi_diversity_fig_clean <- ggplot(allfungi_hill_table_melted_clean, aes(x = Diversity_order, y = Hill_number, fill = Management_type)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#ffffff", "#a9a9a9")) +
  xlab("Order of diversity (q)") +
  ylab("Hill number") +
